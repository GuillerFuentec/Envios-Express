...
export const validateShipment = ({ weightLbs, deliveryDate, cityCuba, contentType }) => {
  const errors = {};
...
export const validatePreferences = ({
  ...
  const hasManualAddress = Boolean(pickupAddress && pickupAddress.trim().length > 5);

  if (pickup && !hasPlaceId && !hasManualAddress) {
