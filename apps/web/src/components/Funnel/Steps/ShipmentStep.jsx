...
const ShipmentStep = ({
  ...
  return (
    <div className="fields-grid">
      ...
      <div className="field">
        <FormLabel htmlFor="weightLbs">Peso estimado (lb)*</FormLabel>
        <FormControl
          id="weightLbs"
          type="number"
          min="0"
      ...
      <div className="field">
        <FormLabel htmlFor="cityCuba">Ciudad de destino en Cuba</FormLabel>
        <FormControl
          as="select"
          id="cityCuba"
          value={data.cityCuba}
      ...
      <div className="field">
        <FormLabel htmlFor="contentType">Contenido principal</FormLabel>
        <FormControl
          as="select"
          id="contentType"
      ...
      {isCash && (
        <div className="field">
          <FormLabel htmlFor="cashAmount">Cantidad de dinero en efectivo (USD)</FormLabel>
          <FormControl
            id="cashAmount"
            type="number"
            min="20"
            ...
            onChange={(event) => onChange("shipment", "cashAmount", event.target.value)}
            placeholder="Ej. 100"
          />
          {errors.cashAmount && <span className="field-error">{errors.cashAmount}</span>}
        </div>
      )}
      ...
      <div className="field">
        <FormLabel htmlFor="deliveryDate">Fecha estimada de entrega*</FormLabel>
        <FormControl
          id="deliveryDate"
          type="date"
          min={minDate}
